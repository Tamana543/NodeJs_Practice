...
router.get('/',(req,res)=>{
     ...
     res.render('shop',{prods : products , pageTitle : 'Shop',path:'/',prodsExist : products.length > 0})// to render the default templates of shop.pug based the default tecmplate, and sinding the dynamic data (I had store and make it map through the js object ) to the pug file 
