...
router.get('/',(req,res)=>{
     ...
     res.render('shop',{prods : products , fileTitle : 'Shop'})// to render the default templates of shop.pug based the default tecmplate, and sinding the dynamic data (I had store and make it map through the js object ) to the pug file 
